  ...
  return (
    <nav className={`${navbarBackground} ${navbarTop0} fixed z-40 w-full py-6 transition`}>
      <div className="flex items-center justify-between mx-auto w-5/6">
        ...
        {/* DESKTOP NAV */}
        <div className={`${opensans.className} hidden lg:flex justify-between gap-10 text-base font-semibold`}>
          <LinkTemplate
            page="Начало"
        ...
        <button
          className="block lg:hidden rounded-full bg-inherit p-2"
        ...
        {/* MOBILE MENU POPUP */}
        <div
          className={`${mobileMenuVisibility} inset-0 z-40 items-center justify-center bg-black bg-opacity-80`}
          onClick={closeModal}
          ref={modalRef}
        >
          <motion.div
